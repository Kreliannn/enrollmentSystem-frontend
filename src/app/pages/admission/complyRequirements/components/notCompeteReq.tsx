...
export function NotCompleteReqForm({student, setStudent, setIsPrinting, requirements } : {  requirements : string[], setIsPrinting : (value : boolean) => void,student : getStudentInterface, setStudent : (student : getStudentInterface | null) => void}) {

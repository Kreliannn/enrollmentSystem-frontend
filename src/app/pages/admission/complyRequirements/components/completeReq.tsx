...
export function CompleteReqForm( {student, setStudent, setIsPrinting} : { setIsPrinting : (value : boolean) => void,student : getStudentInterface, setStudent : (student : getStudentInterface | null) => void}) {
